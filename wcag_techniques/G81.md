# Technique G81: Providing a synchronized video of the sign language interpreter that can
          be displayed in a different viewport or overlaid on the image by the player

## About this Technique

This technique relates to [1.2.6: Sign Language (Prerecorded)](https://www.w3.org/WAI/WCAG22/Understanding/sign-language-prerecorded) (Sufficient using a more specific technique).
